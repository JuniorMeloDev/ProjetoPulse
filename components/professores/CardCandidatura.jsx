...
function ProjetoCard({ projeto, onDelete }) {
        ...
        <div>
            ...
            >
                <div className="bg-slate-100 p-6 rounded-lg shadow-lg">
                     <h2 className="text-xl font-bold mb-2 line-clamp-1 ">Aluno: {projeto.nome}</h2>
                    <p className="text-gray-700 mb-4 line-clamp-2"><strong>Resumo experiências: </strong>{projeto.habilidade}</p>
                </div>
            </div>
            ...
            {modalAberto && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="modal-content bg-white p-6 rounded-lg shadow-lg z-10">
                        ...
                        <p className='mb-2'><strong>Tipo do Projeto:</strong> {projeto.id}</p>
