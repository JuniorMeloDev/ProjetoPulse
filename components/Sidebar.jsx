			...
			<div className="h-full p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
				...
				<div className="pt-7 pb-23 divide-y divide-gray-700">
					<ul className="pt-2 pb-4 space-y-1 text-sm">
						...
						<li>
							<Link href="/notificacoes" className="flex items-center p-2 space-x-3 rounded-md">
								<IoIosNotificationsOutline className='w-5 h-5' />
								<span>Notificações</span>
							</Link>
						</li>
						<li>
							<Link href="/meusprojetos" className="flex items-center p-2 space-x-3 rounded-md">
					...
					<ul className="pt-4 pb-2 space-y-1 text-sm">
						<li>
							<Link href="/configuracoes" className="flex items-center p-2 space-x-3 rounded-md">
								<AiOutlineSetting className='w-5 h-5' />
								<span>Configurações</span>
							</Link>
						</li>
						<li>
							<Link href="/ajuda" className="flex items-center p-2 space-x-3 rounded-md">
