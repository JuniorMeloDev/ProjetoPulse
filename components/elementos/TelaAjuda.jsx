...
const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await fetch('http://localhost:8080/suporte/mensagem/enviar', {
            method: 'POST',
            headers: {
                                ...
                                <div className="relative mb-6 rounded-md bg-slate-100" data-te-input-wrapper-init>
                                    <textarea
                                     onChange={e => setMensagem(e.target.value)}
                                        className="peer block min-h-[auto] w-full rounded border-0 bg-transparent py-[1.4rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
